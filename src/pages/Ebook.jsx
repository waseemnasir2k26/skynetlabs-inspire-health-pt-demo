  ...
  return (
    <div className="card-brass mx-auto max-w-md p-7 sm:p-8">
      ...
      <div className="mt-6 flex items-baseline justify-between border-y border-line py-4">
        ...
        <span className="display text-3xl" style={{ color: "var(--c-accent)" }}>
          {EBOOK.price}
        </span>
      </div>
  ...
  return (
    <main>
      ...
      <header
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 0%, rgba(15,48,36,0.4), transparent 62%), linear-gradient(180deg,#11150F,var(--c-bg))",
        }}
      >
        <Section className="grid items-center gap-14 pb-20 pt-28 lg:grid-cols-2 sm:pt-32">
          <div>
            <Reveal>
              <Eyebrow>{EBOOK.eyebrow}</Eyebrow>
            </Reveal>
            <Reveal delay={70}>
            ...
            <Reveal delay={140}>
              <p className="lede mt-6 max-w-xl">{EBOOK.subtitle}</p>
            </Reveal>

            <Reveal delay={200}>
              <div className="mt-8 flex items-end gap-4">
                <span
                  className="display text-6xl leading-none"
            ...
            <Reveal delay={260}>
              <div className="mt-8 flex flex-wrap items-center gap-5">
                <a
                  href="#get"
                  className="btn-primary inline-block px-9 py-4 text-lg"
                >
                  Get the Guide — {EBOOK.price}
                </a>
        ...
        <Reveal>
          <div className="card mx-auto flex max-w-3xl flex-col items-center gap-7 p-7 text-center sm:flex-row sm:p-9 sm:text-left">
            ...
            <div>
              ...
              <p className="eyebrow mt-1" style={{ color: "var(--c-accent)" }}>
                {founder.cred}
              </p>
      ...
      <Section className="py-12">
        <Reveal>
          <p
            className="serif mx-auto max-w-3xl text-center text-3xl italic leading-snug sm:text-4xl"
            style={{ color: "var(--c-accent)" }}
          >
            {EBOOK.valueLine}
          </p>
      ...
      <Section className="py-12">
        <Reveal>
          <div className="card-green mx-auto max-w-3xl px-6 py-12 text-center sm:px-12">
            ...
            <p
              className="serif mt-3 text-xl italic"
              style={{ color: "var(--c-accent-soft)" }}
            >
              {EBOOK.bonus.lede}
            </p>
            ...
            <p className="eyebrow" style={{ color: "var(--c-accent-soft)" }}>
              {EBOOK.bonus.claimLabel}
            </p>
            <p
              className="serif mx-auto mt-2 max-w-lg text-lg italic"
              style={{ color: "#dce8e2" }}
            >
              {EBOOK.bonus.claim}
            </p>
      ...
      <Section id="get" className="py-16 scroll-mt-28">
        ...
        <Reveal delay={60}>
          <p className="mx-auto mt-7 max-w-md text-center text-sm text-muted">
            {EBOOK.guarantee}
          </p>
        </Reveal>
        <Reveal delay={100}>
          <p className="mx-auto mt-6 max-w-2xl text-center text-xs text-muted2">
            {EBOOK.disclaimer}
          </p>
        </Reveal>
        <Reveal delay={120}>
          <p className="mx-auto mt-2 max-w-2xl text-center text-xs text-muted2">
            {DISCLAIMERS.medical}
          </p>
        </Reveal>
        ...
        <Reveal delay={160}>
          <div className="mt-10 text-center">
            <Btn to="vault-offer" go={go} variant="underline">
              Want the full program? Meet The Founder’s Vault.
            </Btn>
          </div>
        </Reveal>
      </Section>
